...
.. timed:: timed1
   ...
   .. selectquestion:: class_exp2-pre-1
      :fromid: pretest_cond_with_funcs
      :points: 1

   .. selectquestion:: class-exp2-pre-2
      :fromid: pretest-type-compare
      :points: 1

   .. selectquestion:: class-exp2-pre-3-v2
      :fromid: pretest-mult-if
      :points: 1

   .. selectquestion:: class-exp2-pre-4
      :fromid: pretest_complex_list_string
      :points: 1

   .. selectquestion:: class-exp2-pre-5
      :fromid: pretest_sum_with_range
      :points: 1

   .. selectquestion:: class-exp2-pre-6
      :fromid: pretest_string_abbrev
      :points: 1

   .. selectquestion:: class-exp2-pre-7
      :fromid: pretest_sum_with_mod
      :points: 1

   .. selectquestion:: class-exp2-pre-8
      :fromid: pretest-while-str-concat
      :points: 1

   .. selectquestion:: class-exp2-pre-9
      :fromid: pretest-break-cont-str-cont
      :points: 1

   .. selectquestion:: class-exp2-pre-10
